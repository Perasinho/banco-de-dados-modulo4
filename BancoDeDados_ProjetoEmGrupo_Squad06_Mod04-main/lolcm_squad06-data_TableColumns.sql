...
-- Inserindo dados na tabela columns.
INSERT INTO columns (ColumnName, ColumnDescription) VALUES
("Adress", "website address the data is scraped from"),
...
("bDragons","List of minutes that Blue Team killed a dragon Dragon Type"),
...
("rKills","List of Red Team's kills - [Time in minutes, Victim, Killer, Assist1, Assist2, Assist3, Assist4, x_pos, y_pos]"),
("rTowers","List of minutes that Red Team destroyed a tower and Tower Location"),
("rInhibs","List of minutes that Red Team destroyed an inhibitor and Location"),
("rDragons","List of minutes that Red Team killed a dragon and Dragon Type"),
...
-- Testando se os dados foram inseridos corretamente na tabela columns.
select * from columns;